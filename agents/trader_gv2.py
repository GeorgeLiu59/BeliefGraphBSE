#!/usr/bin/env python3
"""
TraderGV2: Graph Variance 2 - Probabilistic
Configurable: use_cot (True/False), belief_format ('json' or 'nl')

Uses probabilistic distributions for beliefs.
"""
...
class TraderGV2(BaseLLMTrader):
    """Probabilistic belief graph trader - configurable CoT and format"""
